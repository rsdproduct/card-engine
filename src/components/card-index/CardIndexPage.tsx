...
export function CardIndexPage() {
  ...
  const hasFilters = Boolean(search || pillar || mainProduct || status || portal);
  ...
  return (
    <div
      className="min-h-[calc(100vh-5rem)] bg-[#F4F7F9] pb-16"
        ...
        >
          <div className="w-full max-w-sm rounded-2xl bg-white p-5 shadow-xl">
            ...
            <p id="reset-desc" className="mt-2 text-sm text-slate-600">
              This clears your local edits and puts the seed list back. You
              cannot undo.
            </p>
